  ...
  return (
    <div className="w-full flex flex-col items-center gap-25" suppressHydrationWarning>
      ...
      <div className="flex flex-row gap-8 items-center">
        <a href="" className="font-medium hover:text-secondary hover:text-lg duration-300 transition-all">Features</a>
        <a href="" className="font-medium hover:text-secondary hover:text-lg duration-300 transition-all">How it Works</a>
        <a href="" className="font-medium hover:text-secondary hover:text-lg duration-300 transition-all">Pricing</a>
        <a href="" className="font-medium hover:text-secondary hover:text-lg duration-300 transition-all">Reviews</a>
      </div>
      <div className="gap-4 flex flex-row items-center">
        <Link href="/login" className="font-medium hover:text-secondary transition-colors duration-100">Login</Link>
      ...
      <section className="w-full bg-linear-to-r from-emerald-400 to-emerald-700 mt-20 flex justify-around items-center px-20 py-20 text-white">
        <div className="flex flex-col gap-6">
          ...
          <div className="mt-1 flex gap-5">
            <Link href="/login" className="px-8 py-3.5 bg-white text-emerald-600 font-semibold rounded-lg hover:bg-emerald-50 transition-colors shadow-lg hover:shadow-xl">Start A Free Trial</Link>
            <Link href="/signup" className="px-8 py-3.5 bg-linear-to-r from-emerald-500 to-emerald-600 text-white font-semibold rounded-lg hover:scale-105 transition-transform duration-300">Watch Demo</Link>
          </div>
        </div>
        <div>
      ...
      <section className="bg-linear-to-r from-emerald-400 to-emerald-700 w-full py-20 flex flex-col items-center gap-3 text-white">
